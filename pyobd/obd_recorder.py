...
class OBD_Recorder():
    ...
    def record_data(self):
        ...
        while 1:
            ...
            connection = mysql.connector.connect(user='root', password='root', host='localhost', database='log_system')
            cursor = connection.cursor()
            query = 'insert into informations(log_main) values ("'+log_string+'")'
    ...
    def calculate_gear(self, rpm, speed):
        ...
        tyre_circumference = 1.978

        current_gear_ratio = (rps*tyre_circumference)/(kmh*primary_gear*final_drive)
...
o = OBD_Recorder('/home/development/pyobd/log/', logitems)
o.connect()
